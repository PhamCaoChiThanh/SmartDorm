...
export default function TenantInvoice() {
  ...
  const vietQrUrl = `https://img.vietqr.io/image/MB-STK-[CREDIT_CARD_NUMBER]-compact2.png?amount=${total}&addInfo=${encodeURIComponent(qrTransferContent)}&accountName=${encodeURIComponent("Tên Tài Khoản")}`;
